...
uint32 MoonInstanceScript::AddTimer(uint32 pDurationMillisec)
{
...
uint32 MoonInstanceScript::GetTimer(uint32 pTimerId)
{
...
void MoonInstanceScript::RemoveTimer(uint32 & pTimerId)
{
	for(TimerArray::iterator TimerIter = mTimers.begin(); TimerIter != mTimers.end(); ++TimerIter)
	{
		if(TimerIter->first == pTimerId)
...
void MoonInstanceScript::ResetTimer(uint32 pTimerId, uint32 pDurationMillisec)
{
	for(TimerArray::iterator TimerIter = mTimers.begin(); TimerIter != mTimers.end(); ++TimerIter)
	{
		if(TimerIter->first == pTimerId)
...
bool MoonInstanceScript::IsTimerFinished(uint32 pTimerId)
{
	for(TimerArray::iterator TimerIter = mTimers.begin(); TimerIter != mTimers.end(); ++TimerIter)
	{
		if(TimerIter->first == pTimerId)
