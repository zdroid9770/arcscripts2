...
{
	public:
		MOONSCRIPT_FACTORY_FUNCTION(EmalonMinionAI, MoonScriptCreatureAI);
...
{
	public:
		MOONSCRIPT_FACTORY_FUNCTION(KoralonAI, MoonScriptCreatureAI);
...
{
	public:
		MOONSCRIPT_FACTORY_FUNCTION(ToravonAI, MoonScriptCreatureAI);
