...
class Sayge : public ScriptedCreature
{
	public:
		ADD_CREATURE_FACTORY_FUNCTION(Sayge)
		Sayge(Creature *pCreature) : ScriptedCreature(pCreature)
		{
...
class SilasDarkmoon : public ScriptedCreature
{
	public:
		ADD_CREATURE_FACTORY_FUNCTION(SilasDarkmoon)
		SilasDarkmoon(Creature *pCreature) : ScriptedCreature(pCreature)
		{
...
class GevasGrimegate : public ScriptedCreature
{
	public:
		ADD_CREATURE_FACTORY_FUNCTION(GevasGrimegate)
		GevasGrimegate(Creature *pCreature) : ScriptedCreature(pCreature)
		{
...
class Sylannia : public ScriptedCreature
{
	public:
		ADD_CREATURE_FACTORY_FUNCTION(Sylannia)
		Sylannia(Creature *pCreature) : ScriptedCreature(pCreature)
		{
...
class StampThunderhorn : public ScriptedCreature
{
	public:
		ADD_CREATURE_FACTORY_FUNCTION(StampThunderhorn)
		StampThunderhorn(Creature *pCreature) : ScriptedCreature(pCreature)
		{
			RegisterAIUpdateEvent(180000); // Start initial update after: 3mins
		}
...
class Lhara : public ScriptedCreature
{
	public:
		ADD_CREATURE_FACTORY_FUNCTION(Lhara)
		Lhara(Creature *pCreature) : ScriptedCreature(pCreature)
		{
...
class ProfessorThaddeusPaleo : public ScriptedCreature
{
	public:
		ADD_CREATURE_FACTORY_FUNCTION(ProfessorThaddeusPaleo)
		ProfessorThaddeusPaleo(Creature *pCreature) : ScriptedCreature(pCreature)
		{
...
#endif
class Carnies : public ScriptedCreature
{
	public:
		ADD_CREATURE_FACTORY_FUNCTION(Carnies)
		Carnies(Creature *pCreature) : ScriptedCreature(pCreature)
		{
			RegisterAIUpdateEvent(120000); // Start initial update after: 2mins
		}
...
class Flik : public ScriptedCreature
{
	public:
		ADD_CREATURE_FACTORY_FUNCTION(Flik)
		Flik(Creature *pCreature) : ScriptedCreature(pCreature)
		{
			RegisterAIUpdateEvent( 180000 ); // Start initial update after: 3mins
		}
...
class Morja : public ScriptedCreature
{
	public:
		ADD_CREATURE_FACTORY_FUNCTION(Morja)
		Morja(Creature *pCreature) : ScriptedCreature(pCreature)
		{
