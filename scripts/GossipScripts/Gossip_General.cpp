...
void SetupGeneralGossip(ScriptMgr* mgr)
{
	...
	Arcemu::Gossip::Script* lock = new LockSmith;
	...
	mgr->register_creature_gossip(29725, lock);		// Benik Boltshear - Stormwind
	mgr->register_creature_gossip(29728, lock); 	// Walter Soref - Undercity
	mgr->register_creature_gossip(29665, lock); 	// Pazik "The Pick" Prylock - Dalaran
}
