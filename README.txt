...
Installation guide:
1. Clone git://github.com/arcscripts2/arcscripts2.git into arcemu_project_cources\src
2. Run Install.bat, which can be found at arcemu_project_cources\src\arcscriptd2 (for windows users make sure, that git has been 
